...
public class ToastPosition {
	...
	public static void positionToast(Toast toast, View view, Window window,
		...
		// toasts are positioned relatively to decor view, views relatively to
		// their parents, we have to gather additional data to have a common
		// coordinate system
		Rect rect = new Rect();
		window.getDecorView().getWindowVisibleDisplayFrame(rect);
		// covert anchor view absolute position to a position which is relative
		// to decor view
		...
		int heightMeasureSpec = MeasureSpec.makeMeasureSpec(
				metrics.heightPixels, MeasureSpec.UNSPECIFIED);
